...
H1: Höhere R&D Intensität führt zu niedrigerer RoA (expensing effect).
H2: Firmengröße moderiert den negativen Zusammenhang positiv.
...
# Dependent variable: RoA = nicon / at
